...
<h3>
  “The more one succeeds in building complex systems that work,<br>
  the stronger the hunger for knowledge, experience, and self-improvement becomes.”
</h3>

<sub><b>Build • Test • Deploy • Learn • Improve</b></sub>
...
[![Focus](https://img.shields.io/badge/Focus-Backend%20%26%20Automation-2E7D32?style=for-the-badge)](#)
...
```mermaid
flowchart LR
    A[Programming foundations] --> B[Java and Python projects]
    B --> C[Spring Boot backend]
    C --> D[Databases and REST APIs]
    D --> E[Docker and Linux deployment]
    E --> F[CI/CD and cloud basics]
    F --> G[Automation and AI-assisted tools]
    G --> H[Portfolio-ready full-cycle systems]
...
```mermaid
flowchart LR
    Problem[Understand the problem] --> Model[Model the domain]
    Model --> API[Design API and data flow]
    API --> Backend[Implement backend logic]
    Backend --> Validate[Validate input and edge cases]
    Validate --> Test[Add unit and integration tests]
    Test --> Deploy[Prepare deployment]
    Deploy --> Improve[Refactor and document]
```
...
[![LeetCode](https://img.shields.io/badge/LeetCode-pawelqbc-FFA116?style=for-the-badge&logo=leetcode&logoColor=black)](https://leetcode.com/u/pawelqbc/)

<img src="https://leetcard.jacoblin.cool/pawelqbc?theme=dark&font=Inter&ext=heatmap" alt="Paweł Ryfiak LeetCode profile card" />
